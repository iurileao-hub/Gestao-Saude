...
- [ ] Indicadores claros para avaliar desempenho
- [ ] Planejamento além do ciclo orçamentário anual
- [ ] Medição de valor (resultados/custo)
- [ ] Dados usados para decisões (não apenas registro)
- [ ] Porta de entrada definida
- [ ] Protocolos padronizados
- [ ] Gestão ativa da rede credenciada
...
3. **Equilíbrio orgânico/terceirização:** movimento recente = reequilíbrio para capacidade própria
